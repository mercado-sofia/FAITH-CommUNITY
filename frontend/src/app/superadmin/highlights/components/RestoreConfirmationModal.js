    ...
    <div className={styles.modalOverlay} onClick={handleBackdropClick}>
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Restore Highlight</h2>
          <button 
        ...
        <div className={styles.modalBody}>
          <div className={styles.confirmationSection}>
            <p className={styles.confirmationText}>
              Are you sure you want to restore <strong>&ldquo;{highlightTitle}&rdquo;</strong>?
            </p>
            {organizationName && (
            ...
            <div className={styles.infoBox}>
              <p className={styles.infoText}>
                Restoring will make this highlight visible on the public website again. It will be removed from the archive library.
              </p>
            </div>
          </div>
        </div>
