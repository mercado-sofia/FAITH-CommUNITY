    ...
    <div className={styles.modalOverlay} onClick={handleBackdropClick}>
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Archive Program</h2>
          <button 
        ...
        <div className={styles.modalBody}>
          <div className={styles.confirmationSection}>
            <p className={styles.confirmationText}>
              Are you sure you want to archive <strong>&ldquo;{programTitle}&rdquo;</strong>?
            </p>
            {organizationName && (
            ...
            <div className={styles.infoBox}>
              <p className={styles.infoText}>
                Archiving will hide this program from the public website. It will remain in the archive library and can be restored later.
              </p>
            </div>
          </div>
        </div>
