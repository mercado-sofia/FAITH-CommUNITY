...
import styles from './DateSelectionField.module.css'; // reuse your existing styles
...
// helper: Date -> 'YYYY-MM-DD' using centralized utility
const toISO = (d) => {
  return formatDateForAPI(d.toISOString());
};
