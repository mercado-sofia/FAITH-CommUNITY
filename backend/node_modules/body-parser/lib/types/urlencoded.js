...
function parameterCount (body, limit) {
  ...
  do {
    ...
    if (index !== -1) {
      count++
      // If we have 'limit' ampersands, we have 'limit + 1' parameters, which exceeds the limit
      // So reject when count >= limit
      if (count >= limit) return undefined // Early exit if limit exceeded
    }
  } while (index !== -1)
  
  // Number of parameters = number of ampersands + 1
  return count + 1
}
