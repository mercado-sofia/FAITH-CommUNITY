    ...
    <div className={styles.overlay}>
      <div className={styles.modal}>
        <div className={styles.topRow}>
          <div className={actionType === 'activate' ? styles.activateIconContainer : styles.trashIconContainer}>
            <div className={actionType === 'activate' ? styles.activateIconInner : styles.trashIconInner}>
              {actionContent.icon}
            </div>
          </div>
